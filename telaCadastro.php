...
<form method="post" action="cadastro.php" class="row g-3 needs-validation" novalidate>
  <div class="col-md-4">
    ...
    <input name="Nome" type="text" class="form-control" id="validationCustom01"  placeholder="Nome do medicamento" required>
  ...
  <div class="col-md-4">
    ...
    <input  type="text" class="form-control" id="validationCustom02" name="Preço" placeholder="Preço" required>
    <div class="valid-feedback">
      Looks good!
    </div>
  </div>
  <div class="col-md-4">
    ...
    <input type="text" class="form-control" id="validationCustom02" name="qtd" placeholder="Quantidade" required>
    <div class="valid-feedback">
      Looks good!
    </div>
  </div>

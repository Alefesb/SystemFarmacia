...
<form method="post" action="processa_dados.php" class="row g-3 needs-validation" novalidate>
  <div class="col-md-4">
    ...
    <input name="medicamento" type="text" class="form-control" id="validationCustom01" placeholder="Nome do medicamento" required>
  ...
  <div class="col-md-4">
    ...
    <input name="Preço" type="text" class="form-control" id="validationCustom02" placeholder="Preço" required>
    <div class="valid-feedback">
      Looks good!
    </div>
  </div>
